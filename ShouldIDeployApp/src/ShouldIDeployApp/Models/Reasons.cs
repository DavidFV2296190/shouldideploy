...
/// <summary>
/// Port of the English locale reasons from en.json.
/// All reasons are embedded so the app is fully standalone with no external dependencies.
/// </summary>
public static class Reasons
{
    public static readonly string[] ToDeploy =
    [
        "I don't see why not",
        "It's a free country",
        "Go ahead my friend!",
    ...
    public static readonly string[] ToNotDeploy =
    [
    ...
    public static readonly string[] ThursdayAfternoon =
    [
    ...
    public static readonly string[] FridayAfternoon =
    [
        "Not by any chance",
        "U mad?",
    ...
    public static readonly string[] Friday13th =
    [
    ...
    public static readonly string[] Afternoon =
    [
        "You still want to sleep?",
        "Call your partner!",
        "Gonna stay late today?",
    ...
    public static readonly string[] DayBeforeChristmas =
    [
    ...
    public static readonly string[] Christmas =
    [
    ...
    public static readonly string[] NewYear =
    [
